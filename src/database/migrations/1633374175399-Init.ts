...
export class Init1633374175399 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      "CREATE TABLE `point_event` (`id` int NOT NULL AUTO_INCREMENT, `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `title` varchar(30) NOT NULL, `type` enum ('Add', 'Sub') NOT NULL, `amount` int NOT NULL, `resultBalance` int UNSIGNED NOT NULL, `orderItemMerchantUid` char(22) NULL, `userId` int NOT NULL, INDEX `idx-orderItemMerchantUid` (`orderItemMerchantUid`), INDEX `idx-createdAt` (`userId`, `createdAt`), PRIMARY KEY (`id`)) ENGINE=InnoDB"
    );
    await queryRunner.query(
